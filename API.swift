...
public struct CreateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, name: String, description: String? = nil, password: String? = nil) {
    graphQLMap = ["id": id, "name": name, "description": description, "password": password]
  }
...
public struct ModelTodoConditionInput: GraphQLMapConvertible {
  ...
  public init(name: ModelStringInput? = nil, description: ModelStringInput? = nil, password: ModelStringInput? = nil, and: [ModelTodoConditionInput?]? = nil, or: [ModelTodoConditionInput?]? = nil, not: ModelTodoConditionInput? = nil) {
    graphQLMap = ["name": name, "description": description, "password": password, "and": and, "or": or, "not": not]
  }
...
public struct UpdateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, name: String? = nil, description: String? = nil, password: String? = nil) {
    graphQLMap = ["id": id, "name": name, "description": description, "password": password]
  }
...
public struct ModelTodoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, name: ModelStringInput? = nil, description: ModelStringInput? = nil, password: ModelStringInput? = nil, and: [ModelTodoFilterInput?]? = nil, or: [ModelTodoFilterInput?]? = nil, not: ModelTodoFilterInput? = nil) {
    graphQLMap = ["id": id, "name": name, "description": description, "password": password, "and": and, "or": or, "not": not]
  }
...
public final class CreateTodoMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateTodo: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String, description: String? = nil, password: String? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Todo", "id": id, "name": name, "description": description, "password": password, "createdAt": createdAt, "updatedAt": updatedAt])
      }
